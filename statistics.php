...
$url = 'https://www.poznavach.com/sevilla-celta-statistika/';
...
$dom->find('#secondary', 0)->children(1)->innertext = '';
$dom->find('#secondary', 0)->children(2)->innertext = '';



$txt = $header.$dom.$footer;

$myfile = fopen("data/statistics.html", "w") or die("Unable to open file!");
fwrite($myfile, $txt);
fclose($myfile);
